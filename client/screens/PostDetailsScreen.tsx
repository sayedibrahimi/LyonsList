// client/screens/PostDetailsScreen.tsx
// Purpose: This file contains the PostDetailsScreen component that allows users to create a new listing by filling out a form with details such as title, description, price, condition, and category. It includes AI-generated content for convenience and handles image uploads.
// Description: The PostDetailsScreen component uses React Native's built-in components and hooks for state management and navigation. It includes form validation, loading indicators, and error handling. The component also utilizes a custom hook for color scheme detection to apply dark mode styling.
