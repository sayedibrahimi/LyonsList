// client/screens/MyListingsScreen.tsx
// Purpose: This file contains the MyListingsScreen component that displays a list of listings created by the user. It allows users to view, refresh, and navigate to details of their listings. The component handles loading states, error handling, and dark mode styling.
// Description: The MyListingsScreen component uses a FlatList to render the list of user listings. It includes a header, loading indicator, error message, and empty state handling. The component also utilizes custom hooks for authentication and listings management, and it applies styles based on the current color scheme (light or dark mode).
